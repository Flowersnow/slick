...
import { user as userAction } from '../../actions/userActions';

const mapStateToProps = ({ registration }) => ( { registration } );
const mapDispatchToProps = { register: userAction.register };
            ...
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group'}>
                        ...
                        <input type="text" className="form-control" name="description" value={user.description}
                               onChange={this.handleChange}/>
                    </div>
